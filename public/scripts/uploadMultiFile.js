...
$(document).ready(function() {
	...
	$('#btn-form').click(function(event) { 
		...
		if($("*").is("input[name='idCatalog']"))
		{
			Data.append('idCatalog', $("input[name='idCatalog']").val());
		}
		if($("*").is("select[name='idCatalog']"))
		{
			Data.append('idCatalog', $("select[name='idCatalog']").val());
		}
		if($("*").is("input[name='price']"))
		{
			Data.append('price', $("input[name='price']").val());
		}
		if($("*").is("input[name='materials']"))
		{
			Data.append('materials', $("input[name='materials']").val());
		}
		if($("*").is("input[name='specifications']"))
		{
			Data.append('specifications', $("input[name='specifications']").val());
		}
		if($("*").is("input[name='delivery']"))
		{
			Data.append('delivery', $("input[name='delivery']").val());
		}
		if($("*").is("input[name='amount']"))
		{
	...
	$('.img-banner').on('click', function (e) {
		e.preventDefault();
		$('.lightboxJS').attr('id', $(this).attr('href').replace('#', ''));
	});
});