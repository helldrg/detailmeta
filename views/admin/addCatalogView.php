...
<div class="container">
    <div class="panel settings-panel">
		<div class="title-panel">
			<span class="c-white fs-medium ff-SansNarrow">Добавление каталога</span>
			<a href="/admin/viewCatalogs">
				<div class="b-arrow-left"></div>
			</a>
		</div>
		<div class="d-table ff-SansNarrow">
			<form action="/admin/addCatalog" method="post" enctype="multipart/form-data">
				<div class="d-tr d-th">
					...
					<span class="d-td-img">
						<div class="dropped-container">
							<!--<div class="container-drop-img">
								<a href="#img1">
									<img class="d-table-img" src="/public/images/catalogs/.png" style="opacity:.3;">
								</a>
							</div>-->
						</div>
					</span>
