<script>
	$(document).ready(function() {
		...
		$(document).on('click','.read-more',function(e){
			...
			$(".content").append($('<div>').load("/catalog/",{action:"loadContent", id:data, idCatalog:"<?php echo $catalog[0]['id']; ?>"}, function() {
...
<div  class="container">
	<h1 class="page-title c-gray-l fw-normal"><a href="/">Главная</a> > <a href="/catalog">Каталог</a> > <?php echo $catalog[0]['title']; ?></h1>
</div>

<?php if (empty($list)): ?>
	<div class="container">
		<p><span class="fs-medium">Товары не найдены</span></p>
	</div>
<?php else: ?>
